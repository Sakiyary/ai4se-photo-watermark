...
class TestImageProcessor:
    ...
    def test_init(self):
        ...
        assert self.processor.supported_formats == {'.jpg', '.jpeg', '.tiff', '.tif'}
    ...
    def test_process_path_single_file(self):
        ...
        try:
            with patch.object(self.processor.exif_reader, 'get_formatted_date') as mock_exif:
                ...
                expected_output = test_image_path.parent / f"{test_image_path.stem}_watermark{test_image_path.suffix}"
