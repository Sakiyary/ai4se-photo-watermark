  ...
  def _create_widgets(self):
    ...
    try:
      ...
      self.output_dir = tk.StringVar(
          value=str(Path.home() / "Documents" / "WatermarkedImages"))
      ...
      ttk.Radiobutton(name_frame, text="添加后缀",
                      variable=self.naming_mode, value="suffix").pack(anchor=tk.W)
      ttk.Radiobutton(name_frame, text="覆盖原文件", variable=self.naming_mode,
                      value="overwrite").pack(anchor=tk.W)
      ttk.Radiobutton(name_frame, text="自定义前缀",
      ...
      ttk.Entry(suffix_frame, textvariable=self.name_suffix,
