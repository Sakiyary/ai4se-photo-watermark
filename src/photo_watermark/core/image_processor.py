...
class ImageProcessor:
    ...
    def process_directory(
        ...
        logger.info(f"Processing complete: {processed_count}/{len(image_files)} images processed")
    ...
    def process_path(
        ...
        if input_path.is_file():
            ...
            if output_path is None:
                ...
                output_path = input_path.parent / f"{input_path.stem}_watermark{input_path.suffix}"
